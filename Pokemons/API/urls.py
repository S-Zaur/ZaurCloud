...
urlpatterns = [
    ...
    path("fight/", views.fight, name="Pokemons.API.Fight"),
    path("fight/<int:number>/", views.fight, name="Pokemons.API.FightInput"),
    path("fight/fast/", views.fast_fight, name="Pokemons.API.FastFight"),
]
