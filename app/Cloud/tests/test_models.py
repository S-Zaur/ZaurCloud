...
class ModelsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        o = CloudObject.objects.create(real_path="/app/Cloud/tests")
        o2 = CloudObject.objects.create(real_path="/app/Cloud/templates")
        CloudObject.objects.create(real_path="/app/Cloud/static/Cloud/images/file.png")
        CloudObject.objects.create(real_path="/app/Cloud/tests/test_api.py")
        u = User.objects.create_user(username="testuser", password="12345")
        Favorites.objects.create(obj=o, user=u)
    ...
    def test_cloud_object_labels(self):
        co = CloudObject.objects.get(id=1)
    ...
    def test_cloud_object_fields(self):
        ...
        co = CloudObject.objects.get(id=3)
    ...
    def test_cloud_object_eq(self):
        ...
        co3 = CloudObject.objects.get(id=2)
    ...
    def test_shared(self):
        ...
        self.assertEqual(shared.obj, CloudObject.objects.first())
    ...
    def test_favorite(self):
        ...
        self.assertEqual(f.obj, CloudObject.objects.first())
